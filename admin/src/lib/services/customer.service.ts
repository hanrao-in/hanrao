...
export class CustomerService {
  ...
  async submitEnquiry(data: Partial<Enquiry>): Promise<void> {
    ...
    // 2. Auto-promote customer if phone is not registered
  ...
  async updateEnquiry(id: string, updates: Partial<Enquiry>): Promise<Enquiry> {
    ...
    // Auto-update associated Customer status based on lead status updates
  ...
  async createBooking(data: Partial<Booking>): Promise<Booking> {
    ...
    // Auto-promote associated Customer status to 'customer'
